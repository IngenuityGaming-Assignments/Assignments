...
.load((l, r) => {
  ...
  var emiter = new particles.Emitter(container, pConfig);
  var emiter2 = new particles.Emitter(container, pConfig2);
  var emiter3=new particles.Emitter(container,pConfig3);
  var  emiter4=new particles.Emitter(container,pConfig4);
  emiter.emit=false;
  emiter2.emit=false;
  emiter3.emit=false;
  emiter4.emit=false;
